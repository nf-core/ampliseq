...
- [#949](https://github.com/nf-core/ampliseq/pull/949) - The dataset can be filtered for downstream analysis with the metadata sheet. For example to remove negative control samples that were meant for Decontam.
