...
- [#956](https://github.com/nf-core/ampliseq/issues/956) - Added ITSxRust as an optional alternative to ITSx for ITS region extraction via `--its_extractor itsxrust`.
