...
- [#981](https://github.com/nf-core/ampliseq/pull/981) - Standardized samplesheet column names to match nf-core conventions (legacy samplesheet is still valid)
...
- [#983](https://github.com/nf-core/ampliseq/pull/983) - Update documentation
