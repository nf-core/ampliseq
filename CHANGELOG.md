...
- [#548](https://github.com/nf-core/ampliseq/pull/548) - `--filter_ssu` accepted any barrnap hit to a kingdom (any occurence in resulting gff) to choose an ASV, now only ASVs with the kingdom that has the lowest evalue are accepted.
