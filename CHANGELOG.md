...
- [#NNNN](https://github.com/nf-core/ampliseq/pull/NNNN) - `--max_ee_r` is now covered by the existing `test_novaseq` profile instead of a dedicated test, removing the extra CI run added in [#1065](https://github.com/nf-core/ampliseq/pull/1065) (by @erikrikarddaniel)
