...
- [#959](https://github.com/nf-core/ampliseq/pull/959) - Add the possibility to place ASVs in the best matching tree through a spreadsheet with HMM profiles and corresponding reference trees (see https://github.com/nf-core/ampliseq/docs/usage.md#multiple-reference-phylogenetic-placement).
- [#959](https://github.com/nf-core/ampliseq/pull/959) - Add archaeal and bacterial reference trees for phylogenetic placement to `sbdi-gtdb` reference database (see https://github.com/nf-core/ampliseq/docs/usage.md#placement-in-database-provided-phylogenies; only for the current release, i.e. R10-RS226-2).
