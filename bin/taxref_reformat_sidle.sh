...
if [ -d "gg_13_8_otus" ]; then
    ...
    mv SILVA_128_QIIME_release/taxonomy/taxonomy_all/${derep}/consensus_taxonomy_7_levels SILVA_128_QIIME_release_taxonomy_all_${derep}_consensus_taxonomy_7_levels.tax.txt
    # remove uncompressed folder
