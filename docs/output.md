...
- [nf-core/ampliseq: Output](#nf-coreampliseq-output)
  - [Pipeline overview](#pipeline-overview)
    ...
    - [Amplicon sequence variant inferrence with DADA2](#Amplicon-sequence-variant-inferrence-with-DADA2) - Infer Amplicon Sequence Variants (ASVs) and taxonomic classification
...
### Amplicon sequence variant inferrence with DADA2
