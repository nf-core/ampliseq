...
include { QIIME2_EXPORT_ABSOLUTE      } from '../process/qiime2'        addParams( options: params.absolute_options )
include { QIIME2_EXPORT_RELASV        } from '../process/qiime2'        addParams( options: params.relasv_options )
include { QIIME2_EXPORT_RELTAX        } from '../process/qiime2'        addParams( options: params.reltax_options )
include { COMBINE_TABLE               } from '../process/combine_table' addParams( options: params.combine_table_options )
