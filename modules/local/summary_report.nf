process SUMMARY_REPORT  {
    ...
    def params_list_named  = [
        ...
        vsearch_lca_tax ? "vsearch_lca_taxonomy='$vsearch_lca_tax',vsearch_lca_ref_tax_title='User-supplied reference database',vsearch_lca_ref_tax_file='${params.vsearch_lca_ref_tax_custom}',vsearch_lca_ref_tax_citation='Not specified'" : "",
