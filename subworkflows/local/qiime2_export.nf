...
include { COMBINE_TABLE as COMBINE_TABLE_VSEARCH_LCA } from '../../modules/local/combine_table'
...
workflow QIIME2_EXPORT {
    ...
    //combine_table.r (optional), similar to DADA2_table.tsv but with additionally taxonomy merged
    COMBINE_TABLE_VSEARCH_LCA ( QIIME2_EXPORT_RELASV.out.tsv, QIIME2_EXPORT_ABSOLUTE.out.fasta, ch_VSEARCH_LCA_tax_tsv, 'rel-table-ASV_with-VSEARCH-LCA-tax.tsv' )
